...
import './QLTB_CDTB_themsdt.css';
import Down from '../../../../../assets/dashboard/Down.png';
import Add from '../../../../../assets/dashboard/themmoi1.png'
import { Button } from 'antd';
import { Link } from 'react-router-dom';
export default function QLTB_CDTB_themsdt() {
    return (
        <div className="khungtrang">
            ...
            <div className="ban2">
                ...
                <div className="tb2">
                    <label className="phone1_tb2_themsdt">Số điện thoại khẩn cấp: </label><br />
                    <input type="text" className="phone1_tb2_2_themsdt" name="DQL" placeholder="093 025 0645" /><br />

                    <div className="add_more_themsdt">
                        <Link to="/themsokhancap" className="link">
                            <div className="add_more_icon_themsdt">
                                <img src={Add} alt="" className="icon_add_themsdt" />
                            </div>
                            <div className="add_more_name1_themsdt">
                                Thêm số khẩn cấp
                            </div>
                        </Link>
                    </div>
                    ...
                    <br />
                    <label className="phone2_tb2_themsdt">Số điện thoại nhận cuộc gọi: </label><br />
                    <input type="text" className="phone2_tb2_2_themsdt" name="DQL" placeholder="093 025 0645" /><br />
                    <input type="text" className="phone2_tb2_2_themsdt_1" placeholder="Nhập số nhận cuộc gọi" /><br />
                    <div className="add_more1_themsdt">
                        <Link to="/themsdt" className="link">
                            <div className="add_more_icon2_themsdt">
                                <img src={Add} alt="" className="icon_add1_themsdt" />
                            </div>
                            <div className="add_more_name3_themsdt">
                                Thêm số điện thoại nhận cuộc gọi
                            </div>
                        </Link>
                    </div>
                    <br />
                    <label className="phone3_tb2_themsdt">Số điện thoại gửi tin nhắn: </label><br />
                    <input type="text" className="phone3_tb2_2_themsdt" name="DQL" placeholder="092 046 0505" /><br />
                    <br />
