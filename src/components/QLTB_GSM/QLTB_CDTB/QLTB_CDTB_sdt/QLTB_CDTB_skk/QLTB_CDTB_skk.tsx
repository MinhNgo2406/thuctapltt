    ...
    return (
        <div className="khungtrang">
            ...
            <div className="ban2">
                ...
                <div className="tb2">
                    <label className="phone1_tb2_skk">Số điện thoại khẩn cấp: </label><br />
                    <input type="text" className="phone1_tb2_2_skk" name="DQL" placeholder="093 025 0645" /><br />
                    <input type="text" className="phone1_tb2_2_skk_1" placeholder="Nhập số khẩn cấp" /> <br />

                    <div className="add_more_skk">
                        <Link to="/themsokhancap" className="link">
                            <div className="add_more_icon_skk">
                                <img src={Add} alt="" className="icon_add_skk" />
                            </div>
                            <div className="add_more_name1_skk">
                                Thêm số khẩn cấp
                            </div>
                        </Link>
                    </div>
                    ...
                    <br />
                    <label className="phone2_tb2_skk">Số điện thoại nhận cuộc gọi: </label><br />
                    <input type="text" className="phone2_tb2_2_skk" name="DQL" placeholder="093 025 0645" /><br />
                    <div className="add_more1_skk">
                        <Link to="/themsdt" className="link">
                            <div className="add_more_icon2_skk">
                                <img src={Add} alt="" className="icon_add1_skk" />
                            </div>
                            <div className="add_more_name3_skk">
                                Thêm số điện thoại nhận cuộc gọi
                            </div>
                        </Link>
                    </div>
                    <br />
                    <label className="phone3_tb2_skk">Số điện thoại gửi tin nhắn: </label><br />
                    <input type="text" className="phone3_tb2_2_skk" name="DQL" placeholder="092 046 0505" /><br />
                    <br />
